...
<svg width="${p.width}" height="${p.height}" viewBox="0 0 ${p.width} ${p.height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(${paddingLeft}, ${paddingTop})" id="main-content">
...
function generateLanguagesSVG(p: any): string {
  ...
  const segments = languages.map((lang: any, i: number) => {
    ...
    if (w <= 0) return '';
    const rect = `<rect class="lang-segment" data-index="${i}" x="${currentX}" y="0" width="${w}" height="${barHeight}" fill="${lang.color}"/>`;
...
<svg width="${p.width}" height="${p.height}" viewBox="0 0 ${p.width} ${p.height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(${paddingLeft}, ${paddingTop})" class="animate" id="main-content">
    <text x="0" y="18" class="title">Most Used Languages</text>

    <!-- Progress Bar -->
    <g transform="translate(0, 40)" id="progress-bar-container">
      <defs>
        <clipPath id="barClip">
          <rect id="bar-clip-rect" width="${barWidth}" height="${barHeight}" rx="${borderRadius}"/>
        </clipPath>
      </defs>
    ...
    <!-- Legend -->
    <g transform="translate(0, 70)" id="legend-container">
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation: isolate" viewBox="0 0 ${p.width} ${p.height}" width="${p.width}px" height="${p.height}px" direction="ltr">
        ...
        <g clip-path="url(#outer_rectangle)">
            ...
            <g transform="translate(${paddingLeft}, ${paddingTop})" style="isolation: isolate" id="main-content">
