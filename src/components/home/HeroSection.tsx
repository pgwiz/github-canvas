    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <BentoGrid>
              {/* User Stats Card - Green accent - Span 2 */}
              <SpotlightCard className="md:col-span-2 h-full" spotlightColor="rgba(var(--primary), 0.2)">
                <GlassPanel hover accent="green" className="h-full flex flex-col justify-between border-0 bg-transparent shadow-none hover:shadow-none p-0">
                  <div className="p-6">
              ...
              {/* Streak Tracker Card - Teal accent - Span 1 */}
              <SpotlightCard className="md:col-span-1 h-full" spotlightColor="rgba(var(--secondary), 0.2)">
                <GlassPanel hover accent="teal" className="h-full flex flex-col justify-between border-0 bg-transparent shadow-none hover:shadow-none p-0">
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
              ...
              {/* Languages Card - Purple accent - Span 1 */}
              <SpotlightCard className="md:col-span-1 h-full" spotlightColor="rgba(139,92,246, 0.2)">
                <GlassPanel hover accent="purple" className="h-full flex flex-col justify-between border-0 bg-transparent shadow-none hover:shadow-none p-0">
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
              ...
              {/* Activity Card - Pink accent - Span 2 */}
              <SpotlightCard className="md:col-span-2 h-full" spotlightColor="rgba(236, 72, 153, 0.2)">
                <GlassPanel hover accent="pink" className="h-full flex flex-col justify-between border-0 bg-transparent shadow-none hover:shadow-none p-0">
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 rounded-lg bg-pink-500/20 flex items-center justify-center backdrop-blur-sm shadow-[0_0_15px_rgba(236,72,153,0.3)]">
                        <span className="text-2xl">⚡</span>
                      </div>
                      <div>
                        <h3 className="font-semibold text-white">Activity Graph</h3>
                        <p className="text-sm text-white/60">Commits over time</p>
                      </div>
                    </div>
                    <GlassInnerPanel accent="pink" className="h-24 flex items-center justify-center group-hover:bg-pink-500/5 transition-colors">
                      <span className="text-white/40 font-mono text-sm group-hover:text-white/60 transition-colors">Preview Card</span>
                    </GlassInnerPanel>
                  </div>
                </GlassPanel>
