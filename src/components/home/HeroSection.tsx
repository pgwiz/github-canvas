      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            <MagneticButton strength={0.2} className="block">
            ...
            <MagneticButton strength={0.1} className="block">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
            ...
            <TiltCard className="h-full">
               <SpotlightCard className="h-full bg-transparent border-0 overflow-visible" spotlightColor="rgba(12, 247, 9, 0.15)">
            ...
            <TiltCard className="h-full translate-y-[-10px] md:translate-y-[-20px] z-10">
              <SpotlightCard className="h-full bg-transparent border-0 overflow-visible" spotlightColor="rgba(0, 225, 255, 0.15)">
            ...
            <TiltCard className="h-full">
              <SpotlightCard className="h-full bg-transparent border-0 overflow-visible" spotlightColor="rgba(139, 92, 246, 0.15)">
